...
/*
 * This filter is implemented in order to validate
...
public class JWTTokenValidatorFilter extends OncePerRequestFilter{
    ...
    /*
     * Here we define when the filter should be used or not.
     * In this case, the filter is used at every URL path
     * requested by the user except "/clients"
     */
